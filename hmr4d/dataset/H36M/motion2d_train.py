...
class BaseDataset(data.Dataset):
    ...
    def __init__(self,root="inputs/h36m/joints3d.pth",
        original_coord="az",
    ...
    def _load_dataset(self):
        ...
        self.motion_files = trusted_torch_load(fn)
        # Dict of {
        ...
        if not self.lazy_load:
            ...
            self.f_img_dicts = trusted_torch_load(fn)
...
class Dataset(BaseDataset):
    def __init__(self,root="inputs/h36m/joints3d.pth", limit_size=None):
    ...
    def _process_data(self, data, idx):
        ...
        while True:
            ...
            for cam_idx in range(len(cam_Ekeys)):
                ...
                c_motion = matrix.get_relative_position_to(joints_pos_, torch.inverse(gt_T_Eayfz2c)[None])  # N, FJ, 3 world 270, 23, 3
                i_motion2d = project_p2d(c_motion, K[None], is_pinhole=self.is_pinhole)  # (F, 22, 2) #5494188~-17748886 270, 23, 2

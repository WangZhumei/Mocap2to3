...
class PampjpeMotion2Dto3DVisualizerGlobal(pl.Callback):
    def __init__(
        self,
        endecoder_opt,
        top_k=3,
    ...
    def on_predict_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx=0):
        ...
        for b in range(B):
            #if pa_mpjpe_b_m[b]<55 and mpjpe_b_m[b]<80 and mpjpe_t_b_m[b]<400:
            #    continue
            self.pampjpe_55+=1
            l = length[b]
            ...
            if J == 23:
                ...
                o3d_skeleton_animation(
                    ...
                    is_pinhole=is_pinhole,
                    #name="Local-" + txt,
                    name="pa_mpjpe-" + str(int(pa_mpjpe_b_m[b]))+" mpjpe-" + str(int(mpjpe_b_m[b]))+" mpjpe_t-" + str(int(mpjpe_t_b_m[b]))+'   data_info:'+info,
                    skeleton_type=self.skeleton_type,
                )

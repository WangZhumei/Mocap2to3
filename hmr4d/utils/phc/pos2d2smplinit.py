...
import os
import torch
from hmr4d.utils.phc.joints2smpl.smplify_loc2rotinit import joints2smpl


@torch.inference_mode(mode=False)
#def convert_pos2d_to_smpl(pos, device=0, cuda=True, num_smplify_iters=30):
def convert_pos2d_to_smpl_init(pos,init, device=0, cuda=True, num_smplify_iters=150):
    """_summary_

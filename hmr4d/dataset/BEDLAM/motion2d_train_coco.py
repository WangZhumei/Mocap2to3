...
class BaseDataset(data.Dataset):
    def __init__(self,root="inputs/bedlam/joints3d_coco.pth",mid_indices=["all60", "maxspan60"],lazy_load=True,random1024=False, export_data=False,limit_size=None):
    ...
    def _load_data(self, idx):
        ...
        data = {
            "raw_data": raw_data,#[start:end],  # (F, 63)
            "vid": mid,  # (F, 3)
...
class Dataset(BaseDataset):
    def __init__(self,root="inputs/bedlam/joints3d_coco.pth", limit_size=None):
        self.root = root
        self.limit_size = limit_size

...
class Motion2DVisualizer(pl.Callback):
    ...
    def on_predict_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx=0):
        ...
        pred_motion2d_prog = outputs["pred_progress"]["pred_motion2d"]#[:,:,0]  # (B, progress, L, J, 2)
        gt_motion2d = batch["gt_motion2d"]#[:,0]  # (B, L, J, 2)
        #data_info = batch["data_info"]  # (B, L, J, 2)
        # add root at zero
        ...
        for b in range(B):
            ...
            #plt_skeleton_animation(gt_motion2d_, text="gt\n" + info, skeleton_type=self.skeleton_type)

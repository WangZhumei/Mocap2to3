...
import os
import torch
from hmr4d.utils.phc.joints2smpl.smplify_loc2rot2 import joints2smpl


@torch.inference_mode(mode=False)
#def convert_pos2d_to_smpl(pos, device=0, cuda=True, num_smplify_iters=30):
def convert_pos2d_to_smpl(pos, device=0, cuda=True, num_smplify_iters=150):
    """_summary_
    ...
    v,j,t = smplify.joint2smpl(pos)  # [F, 3 + 24 * 3]
    return v,j,t
